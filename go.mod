module github.com/boxesandglue/cli

require (
	github.com/boxesandglue/baseline-pdf v1.0.7
...
require (
	...
	github.com/boxesandglue/gofpdi v1.0.20 // indirect
...
replace github.com/risor-io/risor => /Users/patrick/tmp/go/risor
